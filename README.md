![Build Status](https://travis-ci.org/inmotionhosting/ansible-role-apache.png?>
...
## Role Variables
Available variables are listed below with their default values (you can also se>
...
| apache_config              | Default: `/etc/{{ apache_name }}/conf/{{ apache_>
